    ...
    return (
        <div className={styles.public}>
            ...
            <div className={styles.companies}>
                <h3>Discover the <span>Best TECH</span> Companies in the world!</h3>
                <br />
                        ...
                        companies.map(({ id, name, fileUrl, background }) => (
                            <div key={id} className={styles.company}>
                                ...
                                <div className={styles.info}>
                                    <h4><span>{name}</span><span className={styles.openings}> 10 Openings</span></h4>
                                    <small dangerouslySetInnerHTML={{ __html: background.slice(0, 200) + "... Read more" }}>
